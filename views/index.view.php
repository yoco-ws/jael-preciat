						...
						<div class="row">
							...
							<main class="col-12 col-md-4 main-text">
								...
								<div class="mt-4 mt-md-0 font-base">
									...
									<p>
										Comprender a las empresas desde <strong>diferentes perspectivas</strong>, desde lo interno y lo externo, ha sido un superpoder desarrollado tras años como empleada, empresaria, proveedora y <b>consultora de negocios.</b>
									</p>
								</div>
								<a href="#" class="anchor">
									Conectémos
